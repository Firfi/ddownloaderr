...
export const download = async (url: URL, strict: boolean = false/*static files could fail for many reasons, but don't make a deal out of it*/): Promise<Response | null> => {
